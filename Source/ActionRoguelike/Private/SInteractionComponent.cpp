...
void USInteractionComponent::PrimaryInteract()
{
	...
	//bool bHit = GetWorld()->LineTraceMultiByObjectType(Hit, EyeLocation, End, ObjectQueryParams);
	...
	bool bHit = GetWorld()->SweepMultiByObjectType(Hits, EyeLocation, End, FQuat::Identity, ObjectQueryParams, Sphere);
